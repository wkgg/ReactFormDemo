...
/***/ function(module, exports, __webpack_require__) {
	...
	function addValidateHandler(target) {
	  ...
	  target.prototype.showErrorIfNotValid = function () {
	    if (this.state.validate && !this.isValid()) return React.createElement(
	      'a',
	      null,
	      'error !'
	    );
	...
	var NameComponent = (function (_React$Component) {
	  ...
	  function NameComponent() {
	    _classCallCheck(this, _NameComponent);

	    _get(Object.getPrototypeOf(_NameComponent.prototype), 'constructor', this).call(this);
	    this.state = {
	      name: {},
	      validate: false
	    };
	  ...
	  _createClass(NameComponent, [{
	    ...
	    key: 'isFirstNameValid',
	    value: function isFirstNameValid() {
	      return this.state.name.firstName.length > 5;
	    }
	  }, {
	    key: 'isLastNameValid',
	    value: function isLastNameValid() {
	    ...
	    value: function render() {
	      ...
	      return React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement('input', { name: 'firstName', value: this.state.name.firstName, onChange: this.changeHandler.bind(this, 'name', 'firstName') }),
	          (function () {
	            if (_this.state.validate && !_this.isFirstNameValid()) return React.createElement(
	              'a',
	              null,
	              'error !'
	            );
	        ...
	        React.createElement(
	          ...
	          React.createElement('input', { name: 'lastName', value: this.state.name.lastName, onChange: this.changeHandler.bind(this, 'name', 'lastName') }),
	          (function () {
	            if (_this.state.validate && !_this.isLastNameValid()) return React.createElement(
	              'a',
	              null,
	              'error !'
	            );
	  ...
	  var _NameComponent = NameComponent;
	  NameComponent = addChangeHandler(NameComponent) || NameComponent;
	...
	var TextArea = (function (_React$Component2) {
	  ...
	  function TextArea() {
	    ...
	    _get(Object.getPrototypeOf(_TextArea.prototype), 'constructor', this).call(this);
	    this.state = {
	      container: {},
	      validate: false
	    };
	  ...
	  _createClass(TextArea, [{
	    ...
	    value: function render() {
	      return React.createElement(
	        'div',
	        null,
	        React.createElement('textarea', { name: this.props.name, value: this.state.container[this.props.name], onChange: this.changeHandler.bind(this, 'container', this.props.name) }),
	  ...
	  TextArea = addValidateHandler(TextArea) || TextArea;
	  TextArea = addChangeHandler(TextArea) || TextArea;
	  return TextArea;
	})(React.Component);
	...
	var Form = (function (_React$Component3) {
	  ...
	  _createClass(Form, [{
	    ...
	    key: 'render',
	    value: function render() {
	      var options = [{ value: 'china', label: 'China' }, { value: 'america', label: 'America' }, { value: 'frence', label: 'Frence' }];
	      return React.createElement(
	        'form',
	        null,
	        React.createElement(
	          'h1',
	          null,
	          'Service Initiation Request'
	        ),
	        React.createElement(NameComponent, { onChange: this.handleChange.bind(this), validate: this.state.validate }),
	        React.createElement(
	          'h4',
	          null,
	          'Additional Comments'
	        ),
	        React.createElement(TextArea, { onChange: this.handleChange.bind(this), name: 'comment1', validate: this.state.validate }),
	        React.createElement(TextArea, { onChange: this.handleChange.bind(this), name: 'comment2', validate: this.state.validate }),
	        React.createElement(
	          'div',
	          null,
	          React.createElement(
	...
	React.render(React.createElement(Form, null), document.getElementById('react-container'));
